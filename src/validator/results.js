        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    value = _a.sent();
                    if (value) {
                        return [2 /*return*/, new Success(value)];
                    }
                    else {
                        return [2 /*return*/, f()];
                    }
...
var Success = /** @class */ (function () {
    ...
    Success.prototype.hasMany = function () {
        return false;
    };
    return Success;
}());
...
var Failure = /** @class */ (function () {
    ...
    Failure.prototype.hasMany = function () {
        return false;
    };
    Failure.prototype.isSuccess = function () {
        return false;
    };
    Failure.prototype.toMany = function () {
        return new Many([this]);
    };
    return Failure;
}());
exports.Failure = Failure;
var Many = /** @class */ (function () {
    function Many(failures) {
        this.failures = failures;
    }
    Many.of = function (f) {
        return new Many([f]);
    };
    Many.prototype.isSuccess = function () {
        return false;
    };
    Many.prototype.hasMany = function () {
        return true;
    };
    Many.prototype.toMany = function () {
        return this;
    };
    return Many;
}());
