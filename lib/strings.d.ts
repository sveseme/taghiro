...
export declare function endingWith<T extends string>(value: string, endsWith: T): value is string & EndsWith<T>;
export declare class StartsWith<T extends string> {
    private __startsWith;
}
export declare function startingWith<T extends string>(value: string, startsWith: T): value is string & StartsWith<T>;
